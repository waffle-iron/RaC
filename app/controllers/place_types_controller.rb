class PlaceTypesController < ApplicationController
  ...
  def create
    ...
    if @place_type.save
      @place_type = PlaceType.new
      #redirect_to place_types_url, notice: 'Place type was successfully created.'
     flash[:notice] = 'Place type was successfully created.'
     render :new
    else
      render :new
    end
  ...
  def update
    if @place_type.update(place_type_params)
      redirect_to place_types_url, notice: 'Place type was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    @place_type.destroy
    redirect_to place_types_url, status: :see_other, notice: 'Place type was successfully destroyed.'
  end
